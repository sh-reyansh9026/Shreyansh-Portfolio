  ...
  return (
    ...
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        {/*here menu bar is given so that if screen is smaller as of phone 
        than that home about work contact everything will come upon clicking
         the menu that is why sm:hidden is given which means for smaller screen
          menu bar is hidden*/}
